...
var Interface = /*#__PURE__*/function () {
  ...
  interface_createClass(Interface, [{
    ...
    key: "_section",
    value: function _section(node, context, processed, unresolved, dynamics) {
      ...
      if (context.isrepeating || node.passcontext) {
        if (node.inclusive && (node.passcontext || context.length)) {
          ...
          this._renderOutsideIn(node, _domain, dynode, unresolved, dynamics);
          unresolved.pop();
...
exports.Templatize = __webpack_exports__["default"];
/******/ })()
;